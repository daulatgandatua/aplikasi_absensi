        ...
        <div class="container-fluid">
          ...
          <h1 class="h4 mb-4 mt-4 text-center text-gray-800 ml-2"><i class="fas fa-edit mr-2"></i>Edit Data Dosen</h1>

          <a href="<?php echo base_url('index.php/admin/dosen') ?>" style="margin-left: 110px;"><i class="fas fa-arrow-circle-left mr-1"></i>Kembali</a>

          <?php foreach($user as $u){?>
          <form method="POST" action="<?php echo base_url('index.php/admin/dosen/edit_dosen_aksi') ?>" class="mt-4 shadow p-5 d-block ml-auto mr-auto" style="width: 80%;">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-3">
                    <label for="fakultas" class="mt-1">Fakultas</label>
                  </div>
                  <div class="col-md-9 nim">
                    <input type="text" name="fakultas" id="fakultas" class="form-control" value="<?php echo $u->fakultas ?>">
                    <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $u->id ?>">
                    <?php echo form_error('nip', '<small class="text-danger pl-1">','</small>') ?>
                  </div>
                </div> 
