        ...
        <div class="container-fluid">
          ...
          <h1 class="h4 mb-4 mt-4 text-center text-gray-800 ml-2"><i class="fas fa-plus-circle mr-2"></i>Tambah Dosen</h1>

          <a href="<?php echo base_url('index.php/admin/dosen') ?>" style="margin-left: 110px;"><i class="fas fa-arrow-circle-left mr-1"></i>Kembali</a>

          <form method="POST" action="<?php echo base_url('index.php/admin/dosen/tambah_dosen_aksi') ?>" class="mt-4 shadow p-5 d-block ml-auto mr-auto mb-4" style="width: 80%;">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-3">
                    <label for="fakultas" class="mt-1">Jurusan</label>
                  </div>
                  <div class="col-md-9">
